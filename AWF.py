#youtube : https://www.youtube.com/c/Ace7x
# insta : e_6xm
# github : www.github.com/Ace7x
...
print ("----------------------------------------------------------------------------------------")
print ("\033[93m     i HOPE I HAVE HELPED YOU ^_^ , TY FOR USE MY SCRIPT -Ace7x-")
print ("----------------------------------------------------------------------------------------")
